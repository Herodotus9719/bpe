...
def unpack(text):
    # We do this because 'pytest -v .' prints the arguments to console, and we don't want to print the entire contents
    # of the file.
...
# Test that the tokenizer matches the official GPT-4 tokenizer
@pytest.mark.parametrize("text", test_strings)
...
def test_save_load(special_tokens):
    # Take a slightly more complex piece of text and train the tokenizer, chosen at random
    text = llama_text
    ...
    # Verify that save/load works as expected
